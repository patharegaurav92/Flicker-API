...
namespace FlickrViewer
{
   public partial class FlickrViewerForm : Form
   {
      ...
      // http://www.flickr.com/services/apps/create/apply
       private const string KEY = "512ba94b17108e08ccd48e856b70ddf1";
      ...
      private async void searchButton_Click( object sender, EventArgs e )
      {
        ...
        //privacy_filter=1. Use the inputTextBox.Text.Replace(" ", ",") for tag.
         ...
         try
         {
               ...
               // string result = await flickrTask;
            XDocument xmlResponse = XDocument.Parse( await flickrTask);
                ...
                select new FlickrResult
                {
                    ...
                    URL = string.Format(
                           "https://farm{0}.staticflickr.com/{1}/{2}_{3}.jpg", farm, server, id, secret)
                ...
                if (flickrPhotos.Any())
                {
                    ...
                    var res = flickrPhotos.ToList();
                    
                    imagesListBox.DataSource = res;
         ...
         if ( imagesListBox.SelectedItem != null )
         {
            string selectedURL =
               ( ( FlickrResult ) imagesListBox.SelectedItem ).URL;
                ...
                byte[] imageBytes = await wb.DownloadDataTaskAsync(selectedURL);
